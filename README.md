...
6. Visualize the dta in Power BI
...
This is the stage where you have a scan of what's in the data, errors, inconcsistencies, bugs and corrupted characters etc
...
4. Average views Per Video (Millions)
```DAX
...
| Rank | Channel Name        | Sunscribers (M)  |
|------|---------------------|------------------|
